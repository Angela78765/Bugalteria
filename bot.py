...
def webhook():
    ...
    if cid in active_chats: 
        send_message(cid, "Адміністратора поки що немає в чаті, почекайте будьласка, він незабаром приеднається. Дякую за розуміння💖 ", reply_markup=user_finish_markup())
        return "ok", 200
